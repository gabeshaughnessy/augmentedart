...
echo '<h5 class="sidebar-title">'.$menu_title.'</h5>'; 
	...
	<ul class="thumbnail-menu">
		...
		<li class="menu-item"><a href="/nike-fa15-gtm/page-content/download" ><div class="image-wrapper"><img class="thumbnail" src="<?php bloginfo('stylesheet_directory'); ?>/images/nike-fa15/menu-thumbnails/download.jpg" width="100%" height="auto"/></div>
