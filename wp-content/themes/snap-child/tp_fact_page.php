	...
	<div class="theme-container frame">
		...
		?>
			<div id="page-<?php the_ID(); ?>" class="tp-page">
				...
				?>
				<a target="_blank" href="http://www.travelportland.com/" class="logo-wrapper"><img class="logo" src="<?php bloginfo('stylesheet_directory'); ?>/travel-portland/tp_logo.svg" width="100%" height="auto" alt="Travel Portland" /></a>
