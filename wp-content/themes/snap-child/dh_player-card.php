		...
		<?php while ( have_posts() ) : the_post(); global $post; ?>
			<div id="page-<?php the_ID(); ?>" class="dh-page">
				...
				<div id="sharing" class="section">
					<?php 
					$tweetMessage = urlencode('I hacked the Gibson at Diode Gallery! Check out my sweet player card:');
					$tweetUrl = urlencode("http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");
					?>
				<a href="https://twitter.com/intent/tweet?text=<?php echo  $tweetMessage; ?>&url=<?php echo $tweetUrl; ?>" target="_blank" >Announce your Player Status via Twitter Bird</a>
				<p>and/or</p>
				<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $tweetUrl; ?>" target="_blank" >Post your Player Card to the Book of Faces</a>
				</div>
