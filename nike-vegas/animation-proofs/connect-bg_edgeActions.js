...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",6900,function(sym,e){sym.stop(0);});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",2900,function(sym,e){sym.stop();});
//Edge binding end
