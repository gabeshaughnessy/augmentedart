...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",12653,function(sym,e){sym.play('loop');});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",15634,function(sym,e){sym.stop(0);});
//Edge binding end
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",2117,function(sym,e){sym.stop();});
//Edge binding end
