...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",555,function(sym,e){sym.stop();nikeFirebase.child(userID).set("stop");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",781,function(sym,e){sym.stop(0);nikeFirebase.child(userID).set("stop");});
//Edge binding end
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",947,function(sym,e){sym.stop();nikeFirebase.child(userID).set("stop");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1387,function(sym,e){sym.stop(0);nikeFirebase.child(userID).set("stop");});
//Edge binding end
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",916,function(sym,e){sym.stop();});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1749,function(sym,e){sym.stop(0);});
//Edge binding end
